...
namespace BugTrackerAPI.Migrations
{
    ...
    [Migration("20230202095744_seeduserandbugstables")]
    partial class seeduserandbugstables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BugTracker_API.Models.Bug", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 2, 2, 9, 57, 44, 640, DateTimeKind.Local).AddTicks(315),
